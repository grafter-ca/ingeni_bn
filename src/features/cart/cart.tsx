...
const Cart = () => {
  ...
  if (items.length === 0) return (
    <section className="min-h-screen bg-gray-900 font-poppins flex flex-col items-center justify-center gap-6 px-6">
  ...
  return (
    <section className="min-h-screen bg-gray-900 font-poppins text-white">
