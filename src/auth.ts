  ...
  return betterAuth({
    ...
    emailVerification: {
      ...
      sendVerificationEmail: async ({ user, url }) => {
        // Extract the token parameter generated by Better Auth
        ...
        // Execute email dispatch asynchronously so registration response returns immediately without hanging UI
        setImmediate(async () => {
          try {
            console.log(`📩 Background dispatch: sending verification email to: ${user.email}`);
            ...
            const mailOptions = {
              ...
              html: `
                <div style="font-family: sans-serif; max-width: 600px; padding: 20px; color: #111;">
                  ...
                  <a href="${frontendVerificationLink}" style="background: #2563eb; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 8px; display: inline-block; font-weight: 600;">
                    Verify Email
                  </a>
                  <div style="margin-top: 24px; font-size: 12px; color: #666;">
                    <p>Or copy and paste this link into your browser:</p>
                    <p><a href="${frontendVerificationLink}" style="color: #2563eb;">${frontendVerificationLink}</a></p>
            ...
            console.error("❌ Failed to send verification email via Nodemailer in background:", err);
          }
        });
      },
    },
