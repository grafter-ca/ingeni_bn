...
import { filledFields } from "../../constants";
...
export default function RegisterForm({handleSubmit, handleChange,error,formData}: RegisterFormProps) {
  ...
  return (
    <form className="flex flex-col gap-2 mt-4" onSubmit={handleSubmit}>
        ...
        <Button label="Register" className="hover:bg-gray-800 hover:shadow shadow-gray-700 transition-all duration-700" />
      </form>
  )
}
